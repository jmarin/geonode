...
urlpatterns = patterns('',
    ...
    url(r'^groups/$', 'geonode.people.views.people_group_list', name="people_group_list"),
    url(r'^groups/group/(?P<slug>[-\w]+)/$', 'geonode.people.views.people_group_detail', name='people_group_detail'),
    url(r'^groups/group/(?P<slug>[-\w]+)/members/$', 'geonode.people.views.people_group_members', name='people_group_members'),
    url(r'^groups/group/(?P<slug>[-\w]+)/invite/$', 'geonode.people.views.people_group_invite', name='people_group_invite'),
    url(r'^groups/group/[-\w]+/invite/(?P<token>[\w]{40})/$', 'geonode.people.views.people_group_invite_response', name='people_group_invite_response'),
