...
urlpatterns = patterns('',
    ...
    url(r'^groups/group/(?P<slug>[-\w]+)/maps/$', 'geonode.groups.views.group_add_maps', name='group_add_maps'),
    url(r'^groups/group/(?P<slug>[-\w]+)/layers/$', 'geonode.groups.views.group_add_layers', name='group_add_layers'),
    url(r'^groups/group/(?P<slug>[-\w]+)/remove/$', 'geonode.groups.views.group_remove_maps_data', name='group_remove_maps_data'),
