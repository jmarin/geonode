...
urlpatterns = patterns('',
    ...
    url(r'^people/$', 'geonode.people.views.people_group_list', name="people_group_list"),
    url(r'^people/group/(?P<slug>[-\w]+)/$', 'geonode.people.views.people_group_detail', name='people_group_detail'),
    url(r'^people/group/(?P<slug>[-\w]+)/members/$', 'geonode.people.views.people_group_members', name='people_group_members'),
    url(r'^people/group/(?P<slug>[-\w]+)/invite/$', 'geonode.people.views.people_group_invite', name='people_group_invite'),
